...
import { requireNativeComponent, findNodeHandle, View, UIManager } from 'react-native'
...
class MapView extends Component {
    ...
    _sendCommand(command, params = null) {
        UIManager.dispatchViewManagerCommand(findNodeHandle(this), UIManager.AMapView.Commands[command], params)
    }
